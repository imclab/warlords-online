...
public class BattleReportActivity extends BaseGameActivity implements OnLeaderboardScoresLoadedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myArmyIndex = args.getInt("army_index");
    ...
    private void setupUI() {
        ...
        for (Player player : battle.getPlayers()) {
            ...
            if (player.getArmyIndex() == myArmyIndex) {
                playerName.setText("Me");
            } else {
    ...
    public void onSignInSucceeded() {
        ...
        if (mIsVictory && battle.getTurnCount() < 8) {
            gameClient.unlockAchievement(getString(R.string.achievement_blitzkrieg));
        }
        ...
        if (battle.getTurnCount() >= 5) {
            if (mIsVictory) {
                ...
                if (battle.getPlayers().size() == 8) {
                    gameClient.unlockAchievement(getString(R.string.achievement_big_battle));
                }
                if (battle.getMe(myArmyIndex).getGameStats().getNbBattlesWon() == 0) {
                    gameClient.unlockAchievement(getString(R.string.achievement_back_door));
                }
            }
        } else {
