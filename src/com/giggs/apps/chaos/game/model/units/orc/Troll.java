...
public class Troll extends Unit {
	...
	public Troll(int armyIndex) {
		super(R.string.orcs_troll, R.drawable.orcs_troll_image, "orcs_troll.png", ArmiesData.ORCS, armyIndex, 120, 800,
		        false, WeaponType.normal, ArmorType.unarmored, 120, 6);
	}
}
